class Venta():
    ...
    def __repr__(self):
        representacion = str(
            self.codigoVenta) + " " + "Venta realizada por el empleado:" + " " + self.empleado.nombre + "\n" \
                         + "venta realiza al cliente:" + " " + self.cliente.nombre + " " + "con cedula: " + str(
            self.cliente.cedula) + "\n" \
    ...
    def guardar(self, venta):
        ...
        persitencia_venta.guardar_venta(venta)
